...
if (!empty($bNo) && empty($_COOKIE['main_data' . $bNo])) {
	$sql = 'update main_data set b_hit = b_hit + 1  where b_no = ' . $bNo;
	$result = $db->query($sql);
	if (empty($result)) {
?>
		<script>
...
$sql = 'select b_title, b_content, b_date, b_hit, b_id from main_data where b_no = ' . $bNo;
$result = $db->query($sql);
						...
						<div class="col-6 col-12-medium">
							...
							<article class="boardArticle">
								...
								<!-- <div id="boardView"> -->
									...
									//해당 아이디가 올린 모든 파일이 뜸 
									$query = "SELECT file_id, name_orig, name_save FROM file_address where b_no=$bNo ORDER BY reg_time DESC";
									...
									<div class="btnSet">
										...
										<a href="./mainwriteboard.php">목록</a>
									</div>
